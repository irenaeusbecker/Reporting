# Credentials to Azure Monitor Tables / Log analytics 
$CustomerId = "XXX"
$SharedKey = 'YYY'

#Table Name LogAnalytics
$LogType = "ComputerInformation"
$TimeStampField = ""
...
#Computer info
# https://learn.microsoft.com/de-de/windows/win32/cimwin32prov/win32-computersystem
$ComputerInfo = Get-ComputerInfo
$OSLevel = $ComputerInfo.OsVersion
$OSDisplayVersion = $ComputerInfo.OSDisplayVersion
$Manufacturer = $ComputerInfo.CsManufacturer
$Manufacturer = $ComputerInfo.CsManufacturer
$Get_Current_Model = $ComputerInfo.CsModel
$OSDisplayVersion = $ComputerInfo.OSDisplayVersion
